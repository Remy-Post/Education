...
function result() {
    ...
    if (customName.value !== String(null)){
    ...
    if (document.getElementById("metric").checked) {
        ...
        newStory = newStory.replace('94 farenheit', '34 degrees');
    ...
    document.querySelector("article p").style.visibility = 'visible';
    document.querySelector("article p").textContent = newStory;
